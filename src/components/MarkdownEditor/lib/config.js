 ...
 * @License: MIT
 * @Copyright: 2017
 * @desc Initialization configuration item
 */

import help_vi from './lang/vi/help_vi.md';
...
import words_vi from './lang/vi/words_vi.json';
...
export const CONFIG = {
    ...
    'words_de': words_de,
    'words_ja': words_ja,
    'langList': [ 'vi', 'en', 'zh-CN', 'fr', 'pt-BR', 'ru', 'de', 'ja'],
    'toolbars': {
        'bold': true,
        'italic': true,
        'header': true,
