...
<script type="text/ecmascript-6">
    export default {
        ...
        methods: {
            ...
            $clicks(_type) {
                // Let the parent node bind the event
                if (this.editable) {
...
<style lang="scss" scoped >
    ...
    .op-icon.dropdown-wrapper.dropdown {
        ...
        .popup-dropdown.fade-enter-active {
            opacity: 1;
        }
        .popup-dropdown.fade-leave-active {
            opacity: 1;
            opacity: 0;
        }
        .popup-dropdown.fade-enter {
            opacity: 0;
        }
        ...
        .dropdown-images {
            ...
            .image-show.transition {
                transition: all 0.2s linear 0s;
            }
        }
        .dropdown-images.transition {
            transition: all 0.2s linear 0s;
        }
    }
